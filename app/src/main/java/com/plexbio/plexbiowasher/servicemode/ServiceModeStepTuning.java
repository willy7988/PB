 ...
 */
public class ServiceModeStepTuning extends Fragment {


    public ServiceModeStepTuning() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_service_mode_step_tuning, container, false);
    }
